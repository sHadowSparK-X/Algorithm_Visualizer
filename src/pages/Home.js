		...
		[
			{
				...
				url: "/dfs",
				desc:
					"DFS is searching technique an element in a Graph. Here DFS is using 'Backtracking' for searching an element.	And it's search in Depth of an Graph if elements not found then backtrack will Happen",
			},
			{
				title: "Dijkstra",
				imgSrc: DijkstraImg,
